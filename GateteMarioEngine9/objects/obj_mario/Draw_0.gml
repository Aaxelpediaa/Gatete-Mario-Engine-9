...
if (sprite_index > -1) {
	...
	switch (global.powerup) {
		...
		case (cs_mega): {
			...
			draw_sprite_custom_origin(sprite_index, image_index, round(x), round(y)+1, sprite_get_xoffset(sprite_index), sprite_height, 3*xscale, 3*yscale, 0, image_blend, image_alpha);
		} break;
